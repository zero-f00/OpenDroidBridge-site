const translations = {
  ja: {
    ...
    "home.display.note": "Quest側の録画やスクリーンショット整理に加えて、接続状態を確認したいときにも使えます。",
    "home.ai.eyebrow": "Optional AI CLI assistant",
    "home.ai.title": "AIに聞ける。でも、操作はあなたの確認で。",
    "home.ai.lead": "Codex CLI、Claude Code、Ollama、LM Studioなど、手元のAI CLIやローカルLLMに現在の端末状態を渡して、ファイル整理や復元の手順を相談できます。",
    "home.ai.card.context.title": "文脈を渡す",
    "home.ai.card.context.body": "選択中の端末種別、接続状態、現在フォルダの件数、操作リスク、ユーザーが明示的に追加したMac側参照だけを相談材料にします。",
    "home.ai.card.command.title": "CLI案をもらう",
    "home.ai.card.command.body": "AIはOpenDroidBridgeのUI操作やopendroidctlコマンドを提案します。raw adbより安全な操作手順を優先するプロンプトで実行されます。",
    ...
    "support.note.body": "MacのOSバージョン、端末名、接続状態、表示されたエラーメッセージ、再スキャン後の状態を添えてください。秘密情報や個人ファイルの内容は、必要な場合だけ最小限にしてください。",
  ...
  en: {
    ...
    "home.display.note": "Use it when you want to organize Quest recordings and screenshots, or simply check that the connection is ready.",
    "home.ai.eyebrow": "Optional AI CLI assistant",
    ...
    "home.ai.card.command.title": "Get CLI suggestions",
    "home.ai.card.command.body": "The assistant suggests OpenDroidBridge UI actions or opendroidctl commands, with prompts that prefer safer workflows over raw adb shell commands.",
    ...
    "support.note.body": "Please include your macOS version, device name, connection state, visible error message, and the result after pressing Rescan. Include secrets or private file contents only when necessary and only in the minimum amount needed.",
