const translations = {
  ja: {
    ...
    "support.mail": "サポートリクエストを送る",
    "support.privacy": "プライバシーポリシー",
    "support.note.title": "問い合わせ時にあると助かる情報",
    "support.note.body": "MacのOSバージョン、端末名、接続状態、表示されたエラーメッセージ、再スキャン後の状態を添えてください。公開Issueには住所、電話番号、秘密情報、個人ファイルの内容を記載しないでください。",
    ...
    "privacy.inquiry.body": "プライバシーに関する問い合わせ、開示・訂正・削除の相談は、サポートページに記載された連絡先から送信してください。公開Issueを利用する場合は、個人情報や秘密情報を記載しないでください。",
    ...
    "legal.note.title": "重要",
    "legal.note.body": "所在地、電話番号、正式な販売業者名は、リリース前にApp Store Connect上の販売主体と一致する内容へ確認してください。住所・電話番号は、法令に基づき請求があった場合に遅滞なく開示できる体制が必要です。",
    "legal.seller.title": "販売業者",
    "legal.seller.body": "Yuto Masamura",
    "legal.manager.title": "運営責任者",
    "legal.manager.body": "Yuto Masamura",
    "legal.address.title": "所在地・電話番号",
    "legal.address.body": "請求があった場合には、特定商取引法の表示事項として遅滞なく開示します。請求はサポートページの連絡先から「特商法表示事項の開示請求」として送信してください。公開Issueには住所、電話番号、本人確認資料、その他の個人情報を記載しないでください。",
    "legal.contact.title": "連絡先",
    "legal.contact.body": "サポートページに記載の窓口からお問い合わせください。公開Issueでは扱えない個人情報、返金、法令上の開示請求については、非公開で連絡できる方法を案内します。",
  ...
  en: {
    ...
    "support.mail": "Send a support request",
    "support.privacy": "Privacy Policy",
    "support.note.title": "Helpful details for support",
    "support.note.body": "Please include your macOS version, device name, connection state, visible error message, and the result after pressing Rescan. Do not post addresses, phone numbers, secrets, or private file contents in public issues.",
    ...
    "privacy.inquiry.body": "For privacy questions, or to ask about access, correction, or deletion, use the contact method listed on the support page. If you use a public issue, do not include personal information or secrets.",
    ...
    "legal.note.body": "Before release, confirm that the official seller name, address, and phone disclosure process match the seller in App Store Connect. Address and phone number must be disclosed without delay when legally requested.",
    "legal.seller.title": "Seller",
    "legal.seller.body": "Yuto Masamura",
    "legal.manager.title": "Operations manager",
    "legal.manager.body": "Yuto Masamura",
    "legal.address.title": "Address and phone number",
    "legal.address.body": "These will be disclosed without delay as required display items under Japan's Specified Commercial Transactions Act when requested. Send requests through the support page with the subject 'Request for SCTA display items.' Do not post addresses, phone numbers, identity documents, or other personal information in public issues.",
    "legal.contact.title": "Contact",
    "legal.contact.body": "Use the contact method listed on the support page. For personal information, refunds, or legally required disclosure requests that cannot be handled in public issues, a private contact method will be provided.",
