const translations = {
  ja: {
    ...
    "home.title": "OpenDroidBridge - MacからAndroidとMeta Questへ安全にファイル管理",
    "home.description": "OpenDroidBridgeは、MacからAndroidスマホ/タブレットやMeta QuestへUSB経由で安全にファイル転送・整理できるmacOSアプリです。復元できる削除、同名ファイル保護、スクリーンショット保存、表示ツール、任意のAIチャットに対応します。",
    "home.og.description": "MacからAndroidとMeta Questへ、安全にファイル管理。",
    "home.hero.eyebrow": "macOS file transfer for Android-based devices",
    "home.hero.lead": "MacからAndroidスマホ/タブレットやMeta Questへ、必要なファイルを安全に移動・整理。USB接続、復元できる削除、同名ファイル保護、スクリーンショット保存、表示ツール、任意のAIチャットを一つにまとめます。",
    ...
    "home.hero.fact.ai": "AIは助言だけ",
    "home.core.eyebrow": "Core workflow",
    "home.core.title": "ファイル転送で怖いところを、最初から見える形に。",
    "home.core.lead": "端末の状態、現在の場所、空き容量、検索結果を確認しながら、Macへ保存・端末へ追加・新規フォルダ作成・表示ツール起動まで進められます。",
    "home.card.find.title": "見つける",
    "home.card.find.body": "DCIM、Pictures、Movies、Download、Documents、アプリ領域、Quest録画などへすばやく移動できます。",
    ...
    "home.quest.title": "AndroidスマホやQuestのメディアを、Mac側から整理。",
    "home.quest.item1": "公開用スクショではDemo Phone/Demo Headsetを使い、端末IDを非表示",
    "home.quest.item2": "Quest向けのOculusフォルダ、録画フォルダ、共有ストレージへショートカット",
    "home.quest.item3": "端末ストレージの空き容量と現在のパスを常に表示",
    "home.quest.item4": "USBデバッグ未許可、offline、unauthorized状態も診断から確認",
    ...
    "home.display.eyebrow": "Display Tools",
    "home.display.title": "表示ツールで、接続確認と画面まわりの準備を見える化。",
    "home.display.lead": "表示ツールでは、ADB接続、Quest画面スナップショット、実機情報、Mac画面ソース、ADB forward設定、受信アプリへの接続テスト状態を確認できます。",
    "home.display.note": "実映像の送信やQuest側のVR表示は未実装として明示し、QuestをmacOSの外部モニターとして直接認識させる機能ではないことも画面内で確認できます。",
    "home.ai.eyebrow": "Optional AI planning",
    "home.ai.title": "AIに聞ける。でも、操作はあなたの確認で。",
    "home.ai.lead": "Codex CLI、Claude Code、Gemini CLI、Ollama、LM Studioなど、ユーザーが設定したAIツールに現在の端末状態を渡して、ファイル整理や復元の手順を相談できます。",
    ...
    "home.ai.card.command.body": "AIはOpenDroidBridgeのUI操作や、利用できる場合はopendroidctl形式のコマンド案を返します。raw adbより安全な手順を優先します。",
    ...
    "home.img.quest.alt": "Demo Headsetを選択したOpenDroidBridgeのファイルブラウザ画面",
    "home.img.pixel.alt": "Demo Phoneを選択したOpenDroidBridgeのファイルブラウザ画面",
    "home.img.display.alt": "OpenDroidBridgeの表示ツール画面",
  ...
  en: {
    ...
    "home.title": "OpenDroidBridge - Safe file management from Mac to Android and Meta Quest",
    "home.description": "OpenDroidBridge is a macOS app for safely transferring and organizing files between your Mac, Android devices, and Meta Quest over USB. It supports recoverable deletion, protected replacement, screenshot saving, Display Tools, and optional AI chat.",
    "home.og.description": "Safe file management from Mac to Android and Meta Quest.",
    "home.hero.eyebrow": "macOS file transfer for Android-based devices",
    "home.hero.lead": "Move and organize the files you need between your Mac, Android devices, and Meta Quest with confidence. OpenDroidBridge brings USB connection status, recoverable deletion, protected same-name replacement, screenshot saving, Display Tools, and optional AI chat into one focused app.",
    ...
    "home.hero.fact.mac": "macOS 14+",
    "home.hero.fact.ai": "AI stays advisory",
    "home.core.eyebrow": "Core workflow",
    "home.core.title": "Keep the risky parts of file transfer visible.",
    "home.core.lead": "Check device state, current location, free space, and search results while saving to your Mac, adding to the device, creating folders, and opening Display Tools.",
    "home.card.find.title": "Find",
    "home.card.find.body": "Jump quickly to DCIM, Pictures, Movies, Download, Documents, app areas, Quest recordings, and other folders people use every day.",
    ...
    "home.quest.eyebrow": "Real device preview",
    "home.quest.title": "Organize phone and Quest media from your Mac.",
    "home.quest.item1": "Public screenshots use Demo Phone/Demo Headset names and hide device IDs",
    "home.quest.item2": "Use shortcuts for Oculus folders, Quest recordings, and shared storage",
    "home.quest.item3": "Keep free space and the current path visible",
    "home.quest.item4": "Check USB debugging, unauthorized, and offline states from diagnostics",
    "home.safety.eyebrow": "Safety model",
    ...
    "home.display.eyebrow": "Display Tools",
    "home.display.title": "Inspect connection and screen setup with Display Tools.",
    "home.display.lead": "Display Tools checks ADB connection, Quest screen snapshots, device details, Mac screen sources, ADB forward setup, and receiver-app test status.",
    "home.display.note": "It also shows what is not implemented yet: real video streaming and VR display, and it does not make Quest appear as a native macOS external monitor.",
    "home.ai.eyebrow": "Optional AI planning",
    "home.ai.title": "Ask AI for a plan while you stay in control.",
    "home.ai.lead": "OpenDroidBridge can send current device context to AI tools you already run locally or from your terminal, including Codex CLI, Claude Code, Gemini CLI, Ollama, and LM Studio.",
    ...
    "home.ai.card.command.body": "The assistant suggests OpenDroidBridge UI actions and, when available, opendroidctl-style command ideas. Its prompt prefers safer workflows over raw adb commands.",
    ...
    "home.img.quest.alt": "OpenDroidBridge file browser with Demo Headset selected",
    "home.img.pixel.alt": "OpenDroidBridge file browser with Demo Phone selected",
    "home.img.display.alt": "OpenDroidBridge Display Tools window",
